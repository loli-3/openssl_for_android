...
OPENSSL_OPTIONS="no-apps no-asm no-docs no-engine no-gost no-legacy no-shared no-ssl no-tests no-zlib no-aes no-des no-idea no-camellia no-seed no-bf no-cast no-rc2 no-rc4 no-rc5 no-md2 no-md4 no-ripemd no-mdc2 no-dsa no-dh no-ec no-ssl3 no-tls1 no-tls1_1 no-dtls no-comp no-sock no-krb5 no-cms no-jpake no-capieng"
