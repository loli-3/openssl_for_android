...
OPENSSL_OPTIONS="no-aes no-des no-idea no-camellia no-seed no-bf no-cast no-rc2 no-rc4 no-rc5 no-md2 no-md4 no-md5 no-sha no-ripemd no-mdc2 no-dsa no-dh no-ec no-ecdsa no-ecdh no-ssl3 no-tls1 no-tls1_1 no-tls1_2 no-dtls no-comp no-sock no-engine no-hw no-krb5 no-cms no-jpake no-capieng no-ocsp no-psk no-srp"
